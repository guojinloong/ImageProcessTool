...
// ImageProcessToolView.h : CImageProcessToolView 类的接口
...
class CImageProcessToolView : public CScrollView
{
private:
	CDlgSet *m_pDlgSet;
	CDlgSet m_dlgSet;
...
protected: // 仅从序列化创建
	...
	DECLARE_DYNCREATE(CImageProcessToolView)

// 特性
public:
	CImageProcessToolDoc* GetDocument() const;
...
public:
	...
	afx_msg void OnAdvancedStitch();
	afx_msg void OnEditPaste();
	afx_msg void OnUpdateEditPaste(CCmdUI *pCmdUI);
};

#ifndef _DEBUG  // ImageProcessToolView.cpp 中的调试版本
inline CImageProcessToolDoc* CImageProcessToolView::GetDocument() const
   { return reinterpret_cast<CImageProcessToolDoc*>(m_pDocument); }
#endif
