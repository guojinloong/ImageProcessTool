...
// ImageProcessToolView.cpp : CImageProcessToolView 类的实现
//
...
CImageProcessToolDoc* CImageProcessToolView::GetDocument() const // 非调试版本是内联的
{
...
void CImageProcessToolView::OnAdvancedStitch()
{
	...
	if(nRes == IDOK)
	{
		...
		{
			MessageBox(_T("需要更多图片！"),_T("错误"),MB_OK);
		}
		pano.release();
	}
}